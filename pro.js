...
let body = document.getElementsByTagName("p")[2];
  ...
  /* Random fun to jumble words in the sentences */
...
{
            document.getElementById("disp2").innerHTML="Formed Sentences <span style='fontstyle:italic;color:blue;font-weight:lighter'>(after selecting words):</span>"
...
var n=String(document.getElementById("dis
p3").innerHTML).replace(/\s+$/, "");
